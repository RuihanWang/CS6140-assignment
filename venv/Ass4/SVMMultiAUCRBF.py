...
class SVMMultiAUC:
    def __init__(self, dataSet, cv=10, m=5):
        ...
        self.gs = [2**i for i in range(-15, 6)]
    ...
    def foldup(self):
        ...
        for i in range(self.cv):
            ...
            for c in self.cs:
                for g in self.gs:
                    ...
                    for j in range(self.m):
                        ...
                        clf = OneVsRestClassifier(SVC(C=c, gamma = g,probability=True))
                        ...
                        for j in range(3):
                            if accuracy[j] >= maxaccuracy[j]:
                                maxaccuracy[j] = accuracy[j]
                                bestcs[j] = c
                                bestgs[j] = g
            ...
            tprs = []
            for i in range(3):
                clf = OneVsRestClassifier(SVC(C=bestcs[i], gamma = bestgs[i],probability=True))
